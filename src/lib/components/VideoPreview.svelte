<section class="py-20 relative bg-black overflow-hidden">
  ...
  <!-- Ornament Top-Right (rotated 180) -->
  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-white tracking-wide">Contoh Tari Bedana</h2>
      <div class="w-24 h-1 bg-bedana-gold mx-auto mt-4 rounded-full"></div>
      <p class="text-gray-300 mt-4 max-w-2xl mx-auto leading-relaxed">Saksikan pertunjukan Tari Bedana yang dibawakan dengan indah, menampilkan kekayaan budaya daerah Lampung.</p>
    </div>

    <div class="relative bg-black rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(218,165,32,0.3)] aspect-video border-2 border-bedana-gold/40 group">
